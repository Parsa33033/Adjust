...
import com.adjust.api.repository.OrderRepository;
import com.adjust.api.service.OrderService;
import com.adjust.api.service.dto.OrderDTO;
import com.adjust.api.service.mapper.OrderMapper;
...
public class OrderResourceIT {
    ...
    public void createOrder() throws Exception {
        ...
        assertThat(testOrder.getUsername()).isEqualTo(DEFAULT_USERNAME);
        assertThat(testOrder.getDateOfOrder()).isEqualTo(DEFAULT_DATE_OF_ORDER);
    ...
    public void updateOrder() throws Exception {
        ...
        Order testOrder = orderList.get(orderList.size() - 1);
        assertThat(testOrder.getUsername()).isEqualTo(UPDATED_USERNAME);
        assertThat(testOrder.getDateOfOrder()).isEqualTo(UPDATED_DATE_OF_ORDER);
