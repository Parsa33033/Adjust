...
public class NutritionResourceIT {
    ...
    private static final Integer DEFAULT_MIN_UNIT_LOW = 1;
    private static final Integer UPDATED_MIN_UNIT_LOW = 2;

    private static final Integer DEFAULT_MIN_UNIT_NORMAL = 1;
    private static final Integer UPDATED_MIN_UNIT_NORMAL = 2;

    private static final Integer DEFAULT_MIN_UNIT_MAX = 1;
    private static final Integer UPDATED_MIN_UNIT_MAX = 2;

    private static final Integer DEFAULT_CALORY_BOUNDRY_MIN = 1;
    private static final Integer UPDATED_CALORY_BOUNDRY_MIN = 2;

    private static final Integer DEFAULT_CALORY_BOUNDRY_MAX = 1;
    private static final Integer UPDATED_CALORY_BOUNDRY_MAX = 2;
    ...
    public static Nutrition createEntity(EntityManager em) {
        Nutrition nutrition = new Nutrition()
            ...
            .unit(DEFAULT_UNIT)
            .minUnitLow(DEFAULT_MIN_UNIT_LOW)
            .minUnitNormal(DEFAULT_MIN_UNIT_NORMAL)
            .minUnitMax(DEFAULT_MIN_UNIT_MAX)
            .caloryBoundryMin(DEFAULT_CALORY_BOUNDRY_MIN)
            .caloryBoundryMax(DEFAULT_CALORY_BOUNDRY_MAX)
    ...
    public static Nutrition createUpdatedEntity(EntityManager em) {
        Nutrition nutrition = new Nutrition()
            ...
            .unit(UPDATED_UNIT)
            .minUnitLow(UPDATED_MIN_UNIT_LOW)
            .minUnitNormal(UPDATED_MIN_UNIT_NORMAL)
            .minUnitMax(UPDATED_MIN_UNIT_MAX)
            .caloryBoundryMin(UPDATED_CALORY_BOUNDRY_MIN)
            .caloryBoundryMax(UPDATED_CALORY_BOUNDRY_MAX)
    ...
    public void createNutrition() throws Exception {
        ...
        assertThat(testNutrition.getMinUnitLow()).isEqualTo(DEFAULT_MIN_UNIT_LOW);
        assertThat(testNutrition.getMinUnitNormal()).isEqualTo(DEFAULT_MIN_UNIT_NORMAL);
        assertThat(testNutrition.getMinUnitMax()).isEqualTo(DEFAULT_MIN_UNIT_MAX);
        assertThat(testNutrition.getCaloryBoundryMin()).isEqualTo(DEFAULT_CALORY_BOUNDRY_MIN);
        assertThat(testNutrition.getCaloryBoundryMax()).isEqualTo(DEFAULT_CALORY_BOUNDRY_MAX);
    ...
    public void getAllNutritions() throws Exception {
        ...
        restNutritionMockMvc.perform(get("/api/nutritions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].minUnitLow").value(hasItem(DEFAULT_MIN_UNIT_LOW)))
            .andExpect(jsonPath("$.[*].minUnitNormal").value(hasItem(DEFAULT_MIN_UNIT_NORMAL)))
            .andExpect(jsonPath("$.[*].minUnitMax").value(hasItem(DEFAULT_MIN_UNIT_MAX)))
            .andExpect(jsonPath("$.[*].caloryBoundryMin").value(hasItem(DEFAULT_CALORY_BOUNDRY_MIN)))
            .andExpect(jsonPath("$.[*].caloryBoundryMax").value(hasItem(DEFAULT_CALORY_BOUNDRY_MAX)))
    ...
    public void getNutrition() throws Exception {
        ...
        restNutritionMockMvc.perform(get("/api/nutritions/{id}", nutrition.getId()))
            ...
            .andExpect(jsonPath("$.minUnitLow").value(DEFAULT_MIN_UNIT_LOW))
            .andExpect(jsonPath("$.minUnitNormal").value(DEFAULT_MIN_UNIT_NORMAL))
            .andExpect(jsonPath("$.minUnitMax").value(DEFAULT_MIN_UNIT_MAX))
            .andExpect(jsonPath("$.caloryBoundryMin").value(DEFAULT_CALORY_BOUNDRY_MIN))
            .andExpect(jsonPath("$.caloryBoundryMax").value(DEFAULT_CALORY_BOUNDRY_MAX))
    ...
    public void updateNutrition() throws Exception {
        ...
        assertThat(testNutrition.getMinUnitLow()).isEqualTo(UPDATED_MIN_UNIT_LOW);
        assertThat(testNutrition.getMinUnitNormal()).isEqualTo(UPDATED_MIN_UNIT_NORMAL);
        assertThat(testNutrition.getMinUnitMax()).isEqualTo(UPDATED_MIN_UNIT_MAX);
        assertThat(testNutrition.getCaloryBoundryMin()).isEqualTo(UPDATED_CALORY_BOUNDRY_MIN);
        assertThat(testNutrition.getCaloryBoundryMax()).isEqualTo(UPDATED_CALORY_BOUNDRY_MAX);
