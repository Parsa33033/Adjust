...
public class MoveResourceIT {
    ...
    private static final MoveType DEFAULT_MOVE_TYPE = MoveType.CHEST;
    private static final MoveType UPDATED_MOVE_TYPE = MoveType.SHOULDER;

    private static final WorkoutLocation DEFAULT_PLACE = WorkoutLocation.HOME;
    private static final WorkoutLocation UPDATED_PLACE = WorkoutLocation.GYM;
    ...
    public void createMove() throws Exception {
        ...
        assertThat(testMove.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
        assertThat(testMove.getMuscleName()).isEqualTo(DEFAULT_MUSCLE_NAME);
        assertThat(testMove.getMoveType()).isEqualTo(DEFAULT_MOVE_TYPE);
        assertThat(testMove.getPlace()).isEqualTo(DEFAULT_PLACE);
    ...
    public void updateMove() throws Exception {
        ...
        assertThat(testMove.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
        assertThat(testMove.getMuscleName()).isEqualTo(UPDATED_MUSCLE_NAME);
        assertThat(testMove.getMoveType()).isEqualTo(UPDATED_MOVE_TYPE);
        assertThat(testMove.getPlace()).isEqualTo(UPDATED_PLACE);
