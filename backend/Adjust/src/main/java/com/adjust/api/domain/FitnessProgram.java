...
public class FitnessProgram implements Serializable {
    ...
    @OneToMany(mappedBy = "fitnessProgram", fetch = FetchType.EAGER)
    ...
    public FitnessProgram addWorkouts(Workout workout) {
        ...
        workout.setFitnessProgram(this);
        return this;
    }

    public FitnessProgram removeWorkouts(Workout workout) {
        this.workouts.remove(workout);
        workout.setFitnessProgram(null);
        return this;
    }
    ...
    public FitnessProgram adjustProgram(AdjustProgram adjustProgram) {
