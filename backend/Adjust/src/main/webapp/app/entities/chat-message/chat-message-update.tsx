...
export const ChatMessageUpdate = (props: IChatMessageUpdateProps) => {
  ...
  const { text, image, imageContentType, voice, voiceContentType } = chatMessageEntity;
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : chatMessageEntity} onSubmit={saveEntity}>
              ...
              <AvGroup check>
                <Label id="seenLabel">
                  <AvInput id="chat-message-seen" type="checkbox" className="form-check-input" name="seen" />
