              ...
              {chatMessageList.map((chatMessage, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {chatMessage.image ? (
                      <div>
                        {chatMessage.imageContentType ? (
                          <a onClick={openFile(chatMessage.imageContentType, chatMessage.image)}>
                            <img src={`data:${chatMessage.imageContentType};base64,${chatMessage.image}`} style={{ maxHeight: '30px' }} />
                            &nbsp;
                          </a>
                        ) : null}
                        <span>
                          {chatMessage.imageContentType}, {byteSize(chatMessage.image)}
                        </span>
                      </div>
                    ) : null}
                  </td>
                  ...
                  <td>{chatMessage.seen ? 'true' : 'false'}</td>
                  <td>
