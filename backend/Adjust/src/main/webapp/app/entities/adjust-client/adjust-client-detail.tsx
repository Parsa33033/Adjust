    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{adjustClientEntity.medicalProfileId ? adjustClientEntity.medicalProfileId : ''}</dd>
          <dt>
            <Translate contentKey="adjustApp.adjustClient.tutorials">Tutorials</Translate>
          </dt>
          <dd>
            {adjustClientEntity.tutorials
              ? adjustClientEntity.tutorials.map((val, i) => (
                  <span key={val.id}>
                    <a>{val.id}</a>
                    {adjustClientEntity.tutorials && i === adjustClientEntity.tutorials.length - 1 ? '' : ', '}
                  </span>
                ))
              : null}
          </dd>
