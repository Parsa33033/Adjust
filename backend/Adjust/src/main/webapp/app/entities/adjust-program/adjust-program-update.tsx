        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : adjustProgramEntity} onSubmit={saveEntity}>
              ...
              <AvGroup check>
                <Label id="medicalProfileDoneLabel">
                  <AvInput id="adjust-program-medicalProfileDone" type="checkbox" className="form-check-input" name="medicalProfileDone" />
                  <Translate contentKey="adjustApp.adjustProgram.medicalProfileDone">Medical Profile Done</Translate>
                </Label>
              </AvGroup>
              <AvGroup check>
                <Label id="bodyCompositionDoneLabel">
                  <AvInput
                    id="adjust-program-bodyCompositionDone"
                    type="checkbox"
                    className="form-check-input"
                    name="bodyCompositionDone"
                  />
                  <Translate contentKey="adjustApp.adjustProgram.bodyCompositionDone">Body Composition Done</Translate>
                </Label>
              </AvGroup>
              <AvGroup check>
              ...
              <AvGroup check>
                <Label id="seenByClientLabel">
                  <AvInput id="adjust-program-seenByClient" type="checkbox" className="form-check-input" name="seenByClient" />
                  <Translate contentKey="adjustApp.adjustProgram.seenByClient">Seen By Client</Translate>
                </Label>
              </AvGroup>
              <AvGroup check>
                <Label id="seenBySpecialistLabel">
                  <AvInput id="adjust-program-seenBySpecialist" type="checkbox" className="form-check-input" name="seenBySpecialist" />
                  <Translate contentKey="adjustApp.adjustProgram.seenBySpecialist">Seen By Specialist</Translate>
                </Label>
              </AvGroup>
              <AvGroup check>
              ...
              <AvGroup>
                <Label for="adjust-program-bodyComposition">
                  <Translate contentKey="adjustApp.adjustProgram.bodyComposition">Body Composition</Translate>
                </Label>
                <AvInput id="adjust-program-bodyComposition" type="select" className="form-control" name="bodyCompositionId">
                  <option value="" key="0" />
                  {bodyCompositions
              ...
              <AvGroup>
                <Label for="adjust-program-adjustClient">
                  <Translate contentKey="adjustApp.adjustProgram.adjustClient">Adjust Client</Translate>
                </Label>
                <AvInput id="adjust-program-adjustClient" type="select" className="form-control" name="adjustClientId">
                  <option value="" key="0" />
                  {adjustClients
