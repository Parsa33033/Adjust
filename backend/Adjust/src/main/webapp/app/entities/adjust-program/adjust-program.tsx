            ...
            <tbody>
              {adjustProgramList.map((adjustProgram, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{adjustProgram.medicalProfileDone ? 'true' : 'false'}</td>
                  <td>{adjustProgram.bodyCompositionDone ? 'true' : 'false'}</td>
                  ...
                  <td>{adjustProgram.seenByClient ? 'true' : 'false'}</td>
                  <td>{adjustProgram.seenBySpecialist ? 'true' : 'false'}</td>
                  <td>{adjustProgram.designed ? 'true' : 'false'}</td>
                  <td>
                    {adjustProgram.bodyCompositionId ? (
                      <Link to={`body-composition/${adjustProgram.bodyCompositionId}`}>{adjustProgram.bodyCompositionId}</Link>
                    ) : (
                      ''
                    )}
                  </td>
                  ...
                  <td>
                    {adjustProgram.adjustClientId ? (
                      <Link to={`adjust-client/${adjustProgram.adjustClientId}`}>{adjustProgram.adjustClientId}</Link>
                    ) : (
                      ''
                    )}
                  </td>
