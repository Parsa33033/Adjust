    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{adjustProgramEntity.bodyCompositionId ? adjustProgramEntity.bodyCompositionId : ''}</dd>
          <dt>
          ...
          <dd>{adjustProgramEntity.adjustClientId ? adjustProgramEntity.adjustClientId : ''}</dd>
          <dt>
