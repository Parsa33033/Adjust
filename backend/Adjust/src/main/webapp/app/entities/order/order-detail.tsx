    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {orderEntity.dateOfOrder ? <TextFormat value={orderEntity.dateOfOrder} type="date" format={APP_LOCAL_DATE_FORMAT} /> : null}
          </dd>
          <dt>
            <span id="firstName">
          ...
          <dd>{orderEntity.adjustClientId ? orderEntity.adjustClientId : ''}</dd>
        </dl>
