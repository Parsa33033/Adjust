            ...
            <tbody>
              {orderList.map((order, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{order.dateOfOrder ? <TextFormat type="date" value={order.dateOfOrder} format={APP_LOCAL_DATE_FORMAT} /> : null}</td>
                  ...
                  <td>{order.amount}</td>
                  <td>{order.adjustClientId ? <Link to={`adjust-client/${order.adjustClientId}`}>{order.adjustClientId}</Link> : ''}</td>
