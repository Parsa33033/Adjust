...
export const OrderUpdate = (props: IOrderUpdateProps) => {
  ...
  const { orderEntity, adjustClients, loading, updating } = props;
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : orderEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="dateOfOrderLabel" for="order-dateOfOrder">
                  <Translate contentKey="adjustApp.order.dateOfOrder">Date Of Order</Translate>
                </Label>
                <AvField id="order-dateOfOrder" type="date" className="form-control" name="dateOfOrder" />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup check>
                <Label id="paidLabel">
                  <AvInput id="order-paid" type="checkbox" className="form-check-input" name="paid" />
                  <Translate contentKey="adjustApp.order.paid">Paid</Translate>
                </Label>
              </AvGroup>
              <AvGroup check>
              ...
              <AvGroup>
                <Label id="amountLabel" for="order-amount">
                  <Translate contentKey="adjustApp.order.amount">Amount</Translate>
                </Label>
                <AvField id="order-amount" type="string" className="form-control" name="amount" />
              </AvGroup>
              <AvGroup>
                <Label for="order-adjustClient">
                  <Translate contentKey="adjustApp.order.adjustClient">Adjust Client</Translate>
                </Label>
                <AvInput id="order-adjustClient" type="select" className="form-control" name="adjustClientId">
                  <option value="" key="0" />
                  {adjustClients
