...
import { getEntities as getShoppingItems } from 'app/entities/shopping-item/shopping-item.reducer';
...
export const OrderItemUpdate = (props: IOrderItemUpdateProps) => {
  ...
  const { orderItemEntity, shoppingItems, orders, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adjustApp.orderItem.home.createOrEditLabel">
            <Translate contentKey="adjustApp.orderItem.home.createOrEditLabel">Create or edit a OrderItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : orderItemEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label for="order-item-shoppingItem">
                  <Translate contentKey="adjustApp.orderItem.shoppingItem">Shopping Item</Translate>
                </Label>
                <AvInput id="order-item-shoppingItem" type="select" className="form-control" name="shoppingItemId">
                  <option value="" key="0" />
                  {shoppingItems
                    ? shoppingItems.map(otherEntity => (
...
const mapStateToProps = (storeState: IRootState) => ({
  shoppingItems: storeState.shoppingItem.entities,
