...
export const TutorialUpdate = (props: ITutorialUpdateProps) => {
  ...
  const { tutorialEntity, tutorialVideos, courses, adjustClients, loading, updating } = props;
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : tutorialEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label for="tutorial-course">
                  <Translate contentKey="adjustApp.tutorial.course">Course</Translate>
                </Label>
                <AvInput id="tutorial-course" type="select" className="form-control" name="courseId">
                  <option value="" key="0" />
                  {courses
