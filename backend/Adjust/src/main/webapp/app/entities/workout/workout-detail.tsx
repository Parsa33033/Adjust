...
export const WorkoutDetail = (props: IWorkoutDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="adjustApp.workout.detail.title">Workout</Translate> [<b>{workoutEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{workoutEntity.dayNumber}</dd>
          <dt>
            <Translate contentKey="adjustApp.workout.fitnessProgram">Fitness Program</Translate>
          </dt>
          <dd>{workoutEntity.fitnessProgramId ? workoutEntity.fitnessProgramId : ''}</dd>
        </dl>
