...
export const SpecialistUpdate = (props: ISpecialistUpdateProps) => {
  ...
  const { resume, image, imageContentType } = specialistEntity;
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : specialistEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="birthdayLabel" for="specialist-birthday">
                  <Translate contentKey="adjustApp.specialist.birthday">Birthday</Translate>
                </Label>
                <AvField id="specialist-birthday" type="date" className="form-control" name="birthday" />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                ...
                <AvInput id="specialist-resume" type="textarea" name="resume" />
              </AvGroup>
              <AvGroup>
