        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : conversationEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label for="conversation-adjustClient">
                  <Translate contentKey="adjustApp.conversation.adjustClient">Adjust Client</Translate>
                </Label>
                <AvInput id="conversation-adjustClient" type="select" className="form-control" name="adjustClientId">
                  <option value="" key="0" />
                  {adjustClients
