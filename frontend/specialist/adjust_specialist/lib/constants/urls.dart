...
final String API_KEY = "asdf67898763fuikllikjsdfrtyuiok";
...
final String SPECIALIST_URL = BASE_URL + "/api/specialist/app/specialists";
...
final String PROGRAM_DEVELOPMENT_URL = BASE_URL + "/api/specialist/app/program-developments";


final String CONVERSATION_URL = BASE_URL + "/api/specialist/app/conversation";
