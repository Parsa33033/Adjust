...
import 'package:adjust_specialist/components/adjust_date_picker.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void setAppState(AppState state) {
    setState(() {
      ...
      Jalali jalali = Jalali.fromDateTime(state.specialistState.birthday);
      birthDateConfirmTextFieldController.text =
          getNumber(jalali.year.toString() + "/" + jalali.month.toString() + "/" + jalali.day.toString());
      ...
      degreeTextFieldController.text = state.specialistState.degree;
      busyTextFieldController.text = BUSY_LIST[state.specialistState.busy];
                ...
                child: Container(
                  ...
                  onTap: () async {
                    ...
                    if (i == 1) {
                      ...
                      Navigator.of(context, rootNavigator: true).pop("dialog");
                      Navigator.of(context, rootNavigator: true).pop("dialog");
                      showAdjustDialog(context, t.user.failure, false, null, null);
                    }
                  },
                )))
          ],
                              ...
                              AdjustRaisedButton(
                                ...
                                onPressed: () async {
                                  if (_formKey.currentState.validate()) {
                                    showAdjustDialog(
                                        context, t.user.sure_with_decision, true,
                                        () async {
                                      preloader(context);
                                      String firstName =
                                      ...
                                      if (i == 1) {
                                        if (this.widget.isFromMainPage) {
                                          Navigator.of(context,
                                              ...
                                              .pop("dialog");
                                          mainPageStreamController.add(1);
                                          showAdjustDialog(context, t.user.success,
                                              false, null, null);
                                        } else {
                                          Navigator.of(context,
                                                  rootNavigator: true)
                                        ...
                                        Navigator.of(context,
                                                rootNavigator: true)
                                            .pop("dialog");
                                        showAdjustDialog(context, t.user.failure,
                                            false, null, null);
                                      }
                                    }, null);
                                  }
