...
class _ProgramDevelopmentPageState extends State<ProgramDevelopmentPage> {
  ...
  List<DevelopmentState> programDevelopmentStateList;
  ...
  initState() {
    ...
    nutritionRating = 3;
    fitnessRating = 3;
    this.programDevelopmentStateList = store.state.programListState.programs.reversed.toList()[this.widget.programIndex].developments;
  }
                                  ...
                                  bottomTitles: SideTitles(
                                    ...
                                    getTitles: (value) {
                                      ...
                                      if (listSize <= 0) {
                                        ...
                                        return getNumber(jalaliToString(georgianToJalali(this.programDevelopmentStateList[0].date)));
                                      } else if (listSize == 2) {
                                        if (value.toInt() == 0) {
                                          return getNumber(jalaliToString(georgianToJalali(this.programDevelopmentStateList[0].date)));
                                        } else if (value.toInt() == 1) {
                                          return getNumber(jalaliToString(georgianToJalali(this.programDevelopmentStateList[1].date)));
                                        }
                                      } else if (listSize >= 3) {
                                        if (value.toInt() == 0) {
                                          return getNumber(jalaliToString(georgianToJalali(this.programDevelopmentStateList[0].date)));
                                        } else if (value.toInt() == (listSize / 2).round()) {
                                          return getNumber(jalaliToString(georgianToJalali(this.programDevelopmentStateList[(listSize / 2).round()].date)));
                                        } else if (value.toInt() == listSize - 1) {
                                          return getNumber(jalaliToString(georgianToJalali(this.programDevelopmentStateList[listSize - 1].date)));
                                        }
                                      }
                                      return '';
                                    },
              ...
              child: Column(
                ...
                children: <Widget>[
                  Expanded(
                    flex: 1,
                    child: AdjustText(
                      t.progress.nutrition_assessment,
                      fontSize: 18,
                    ),
                  ),
                  Expanded(
                                    ...
                                    Expanded(
                                        ...
                                        child: FittedBox(
                                          ...
                                          child: Container(
                                              padding: EdgeInsets.all(5),
                                              child: AdjustText(
                                                t.progress.today_fitness_assessment,
                                                fontSize: 18,
                                                color: GREEN_COLOR,
                                              )
                                          ),
...
//                                color: WHITE_COLOR,
                                    ...
                                    Expanded(
                                        ...
                                        child: FittedBox(
                                          ...
                                          child: Container(
                                            padding: EdgeInsets.all(5),
                                            child: AdjustText(
                                              t.progress.today_nutrition_assessment,
                                              fontSize: 18,
                                              color: RED_COLOR,
                                            ),),
                                        ))
                              ...
                              Container(
                                ...
                                child: AdjustRaisedButton(
                                  ...
                                  text: t.main.save + " " + t.main.assess,
                                  onPressed: () {
...
//                                            }
//                                          } else {
//                                            showAdjustDialog(context, t.progress.assessment_done_for_today,
