                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        AdjustTextField(
                            ...
                            hintText: t.user.firstname + " "+ t.main.and + " " + t.user.lastname,
                            enabled: false,
                            icon: Icon(
                              Icons.person,
                              color: GREY_COLOR,
                        ...
                        decimalNumberPicker(
                            ...
                            t.body_composition.height + " (180.5 " + t.body_composition.centimeter +")" + "*",
                            GREEN_COLOR,
                            t.body_composition.height + " " + t.main.to + " " + t.body_composition.centimeter,
                            this.heightNuminal,
                        ...
                        decimalNumberPicker(
                            ...
                            t.body_composition.weight + " (70.5 "+ t.body_composition.kilogram +")" + "*",
                            RED_COLOR,
                            t.body_composition.weight + " " + t.main.to + " " + t.body_composition.kilogram,
                            this.weightNuminal,
                        ...
                        decimalNumberPicker(
                            ...
                            t.body_composition.wrist  + " (18.5 " + t.body_composition.centimeter +")" + "*",
                            ORANGE_COLOR,
                            t.body_composition.wrist + " " + t.main.to + " " + t.body_composition.centimeter,
                            this.wristNuminal,
                        ...
                        decimalNumberPicker(
                            ...
                            t.body_composition.waist + " (88.5 " + t.body_composition.centimeter +")" + "*",
                            GREEN_COLOR,
                            t.body_composition.waist + " " + t.main.to + " " + t.body_composition.centimeter,
                            this.wristNuminal,
                            this.wristDecimal, (value) {
                          if (value == null || value == "") {
                            return t.user.fill;
                        ...
                        decimalNumberPicker(
                            ...
                            t.body_composition.muscle_mass + " ("+ t.body_composition.kilogram +")",
                            RED_COLOR,
                            t.body_composition.muscle_mass + " " + t.main.to + " " + t.body_composition.kilogram,
                            this.wristNuminal,
                            this.wristDecimal, (value) {
                          return null;
                        }),
                        decimalNumberPicker(
                            ...
                            t.body_composition.fat_mass + " ("+ t.body_composition.kilogram +")",
                            ORANGE_COLOR,
                            t.body_composition.fat_mass + " " + t.main.to + " " + t.body_composition.kilogram,
                            this.wristNuminal,
                            this.wristDecimal, (value) {
                          return null;
                        }),
                              ...
                              onPressed: () async {
                                showAdjustDialog(
                                  ...
                                  if (_formKey.currentState.validate()) {
                                    ...
                                    double lbm =
                                    this.clientState.gender == Gender.MALE
                                        ? (0.32810 * weight) +
                                        (0.33929 * height) -
                                        29.5336
                                        : (0.29569 * weight) +
                                    ...
                                    // Find out your age
                                    age = Age.dateDifference(
                                        fromDate: this.clientState.birthDate,
                                        toDate: DateTime.now(),
                                        includeToDate: false);
...
//                                            .pop();
//                                        showAdjustDialog(context, t.user.success , true,
//                                                () {
...
//                                        Navigator.of(context, rootNavigator: true)
//                                            .pop();
//                                        showAdjustDialog(context, t.user.failure , false,
//                                            null, GREEN_COLOR);
//                                      }
