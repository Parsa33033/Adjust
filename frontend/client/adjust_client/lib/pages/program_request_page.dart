...
import 'program_body_composition_page.dart';
      ...
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int pos) {
            ...
            return AdjustInfoButton(
              ...
              width: 150,
              height: 150,
              title: e == null ? "" : t.specialist.field + ": " + e.field + " - " + e.degree,
              ...
              func: () async {
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => AdjustItemPage(
                    ...
                    buttonText: t.main.choose,
                    isInfo: false,
                    primaryColor: YELLOW_COLOR,
                    primaryColorLight: LIGHT_YELLOW_COLOR,
                    backgroundImagePath: "assets/bg_yellow.png",
                    onButtonPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => ProgramBodyCompositionPage(e)));
                    },
                    imageIsCircular: true
                )));
              },
