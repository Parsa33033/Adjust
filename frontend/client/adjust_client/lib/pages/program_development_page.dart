...
class _ProgramDevelopmentPageState extends State<ProgramDevelopmentPage> {
  ...
  initState() {
    ...
    nutritionRating = 3;
    fitnessRating = 3;
    this.programDevelopmentStateList = store
        .state.programListState.programs.reversed
        .toList()[this.widget.programIndex]
        .developments;
  }
                          ...
                          child: LineChart(LineChartData(
                            ...
                            titlesData: FlTitlesData(
                              ...
                              bottomTitles: SideTitles(
                                ...
                                getTitles: (value) {
                                  int listSize =
                                      this.programDevelopmentStateList.length;
                                  if (listSize <= 0) {
                                    return "0";
                                  } else if (listSize == 1) {
                                    return getNumber(jalaliToString(
                                        georgianToJalali(this
                            ...
                            lineBarsData: [
                              LineChartBarData(
                                spots:
                                    this.programDevelopmentStateList.length <= 0
                                        ? [FlSpot(0, 0)]
                                        : this
                                            .programDevelopmentStateList
                                            .map((e) => FlSpot(
...
//                                color: WHITE_COLOR,
                              ...
                              Container(
                                ...
                                child: AdjustRaisedButton(
                                  ...
                                  onPressed: () {
                                    showAdjustDialog(
                                        context, t.progress.note, true,
                                        () async {
                                      // change later to add weight, bmi, lbm and pbf
                                      DevelopmentDTO programDevelopmentDTO =
                                          DevelopmentDTO(
                                              null,
                                              null,
                                              this.nutritionRating,
