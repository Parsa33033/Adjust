...
AppState setClient(AppState state, dynamic action) {
  ...
  clientState.age =
  action.payload.age == null ? clientState.age : action.payload.age;
  clientState.token =
  action.payload.token == null ? clientState.token : action.payload.token;
  clientState.score =
  action.payload.score == null ? clientState.score : action.payload.score;
  clientState.birthDate = action.payload.birthDate == null
      ? clientState.birthDate
      : action.payload.birthDate;
  clientState.image =
  action.payload.image == null ? clientState.image : action.payload.image;
  clientState.imageContentType = action.payload.imageContentType == null ||
      action.payload.imageContentType == ""
      ? clientState.imageContentType
      : action.payload.imageContentType;
  clientState.orders = action.payload.orders == null
      ? clientState.orders
      : action.payload.orders;
  clientState.medicalProfile = action.payload.medicalProfile == null
      ? clientState.medicalProfile
      : action.payload.medicalProfile;
  clientState.tutorialList = action.payload.tutorialList == null
      ? clientState.tutorialList
      : action.payload.tutorialList;
