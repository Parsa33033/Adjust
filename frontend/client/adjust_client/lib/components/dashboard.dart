  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, AppState>(
      ...
      builder: (BuildContext context, AppState state) {
        int l = state.cartState.orderItemListState.length;
        return Container(
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  ...
                                  child: FittedBox(
                                    ...
                                    fit: BoxFit.scaleDown,
                                    child: AdjustText(
                                      t.main.score + ": " + getNumber(this.widget.score.round().toString()),
                                    )
                                  )
                                ),
                                Expanded(
                                  ...
                                  child: FittedBox(
                                    ...
                                    fit: BoxFit.scaleDown,
                                    child: AdjustText(
                                      t.main.token + ": " + getNumber(this.widget.token.round().toString()),
                                    ),
                                  )
                                )
                              ],
