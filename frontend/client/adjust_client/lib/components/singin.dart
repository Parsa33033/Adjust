            ...
            Row(
              ...
              children: <Widget>[
                ...
                AdjustRaisedButton(
                  ...
                  onPressed: () async {
                    preloader(context);
                    String username = emailTextFieldController.text.trim().toLowerCase();
                    ...
                    if (i == 1) {
                      ...
                      Navigator.of(context, rootNavigator: true).pop("dialog");
                      showAdjustDialog(context, t.user.login_failed, false, null, null);
                    }
                  },
                )
              ],
                    ...
                    children: <Widget>[
                      ...
                      Container(
                          child: AdjustRaisedButton(
                            ...
                            onPressed: () async{
                              preloader(context);
                              int i = await sendPasswordRecoveryEmail(emailRecoverPassTextFieldController.text.trim().toLowerCase());
                              if (i == 1) {
                                Navigator.of(context, rootNavigator: true).pop("dialog");
                                Navigator.of(context, rootNavigator: true).pop("dialog");
                                showAdjustDialog(context, t.user.success, false, null, null);
                              } else if (i == 0) {
                                Navigator.of(context, rootNavigator: true).pop("dialog");
                                Navigator.of(context, rootNavigator: true).pop("dialog");
