...
class NumberPicker extends StatelessWidget {
  ...
  Widget _integerListView(ThemeData themeData) {
    TextStyle defaultStyle = TextStyle(fontFamily: "Iransans", fontSize: 15, color: Colors.black,);
    TextStyle selectedStyle =
    themeData.textTheme.headline.copyWith(color: this.color, fontFamily: "Iransans");
              ...
              ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return isExtra
                      ...
                      : Center(
                    child: Text(
                      getNumber(getDisplayedValue(value)),
                      style: itemStyle,
                    ),
                  );
                },
