...
class Body_compositionTranslations_fa extends Body_compositionTranslations {
	...
	NotesBody_compositionTranslations_fa get notes => NotesBody_compositionTranslations_fa(this);
	...
	Workout_locationBody_compositionTranslations_fa get workout_location => Workout_locationBody_compositionTranslations_fa(this);
	GoalBody_compositionTranslations_fa get goal => GoalBody_compositionTranslations_fa(this);
	Activity_typeBody_compositionTranslations_fa get activity_type => Activity_typeBody_compositionTranslations_fa(this);
	Workout_typeBody_compositionTranslations_fa get workout_type => Workout_typeBody_compositionTranslations_fa(this);
	Body_typeBody_compositionTranslations_fa get body_type => Body_typeBody_compositionTranslations_fa(this);
}

class NotesBody_compositionTranslations_fa extends NotesBody_compositionTranslations {
	final Body_compositionTranslations_fa _parent;
	const NotesBody_compositionTranslations_fa(this._parent):super(_parent);
...
class Workout_locationBody_compositionTranslations_fa extends Workout_locationBody_compositionTranslations {
	final Body_compositionTranslations_fa _parent;
	const Workout_locationBody_compositionTranslations_fa(this._parent):super(_parent);
	String get workout_location => """مکان تمرین""";
	String get gym => """باشگاه""";
	String get home => """خانه""";
}

class GoalBody_compositionTranslations_fa extends GoalBody_compositionTranslations {
	final Body_compositionTranslations_fa _parent;
	const GoalBody_compositionTranslations_fa(this._parent):super(_parent);
	String get goal => """هدف""";
	String get decrease_weight => """کاهش وزن""";
	String get increase_weight => """افزایش وزن""";
}

class Activity_typeBody_compositionTranslations_fa extends Activity_typeBody_compositionTranslations {
	final Body_compositionTranslations_fa _parent;
	const Activity_typeBody_compositionTranslations_fa(this._parent):super(_parent);
...
class Workout_typeBody_compositionTranslations_fa extends Workout_typeBody_compositionTranslations {
	final Body_compositionTranslations_fa _parent;
	const Workout_typeBody_compositionTranslations_fa(this._parent):super(_parent);
...
class Body_typeBody_compositionTranslations_fa extends Body_typeBody_compositionTranslations {
	final Body_compositionTranslations_fa _parent;
	const Body_typeBody_compositionTranslations_fa(this._parent):super(_parent);
	...
	Body_status_answersBody_typeBody_compositionTranslations_fa get body_status_answers => Body_status_answersBody_typeBody_compositionTranslations_fa(this);
	String get body_shape => """حالت بدن شما شبیه چه است؟""";
	Body_shape_answersBody_typeBody_compositionTranslations_fa get body_shape_answers => Body_shape_answersBody_typeBody_compositionTranslations_fa(this);
	String get childhood => """شما هنگام کودکی چگونه بودید؟""";
	Childhood_answersBody_typeBody_compositionTranslations_fa get childhood_answers => Childhood_answersBody_typeBody_compositionTranslations_fa(this);
	String get activity => """سطح فعالیت شما در کل چگونه است؟""";
	Activity_answersBody_typeBody_compositionTranslations_fa get activity_answers => Activity_answersBody_typeBody_compositionTranslations_fa(this);
	String get metabolism => """سوخت و ساز بدن شما چگونه است؟""";
	Metabolism_answersBody_typeBody_compositionTranslations_fa get metabolism_answers => Metabolism_answersBody_typeBody_compositionTranslations_fa(this);
	String get people_say => """مردم به شما میگویند؟""";
	People_say_answersBody_typeBody_compositionTranslations_fa get people_say_answers => People_say_answersBody_typeBody_compositionTranslations_fa(this);
	String get wrist => """اگر مچ دستتان را با دست دیگر بگیرید وضعیت انگشت میانی و شست چگونه است؟""";
	Wrist_answersBody_typeBody_compositionTranslations_fa get wrist_answers => Wrist_answersBody_typeBody_compositionTranslations_fa(this);
	String get weight => """در خصوص وزن بدن شما متوانید...""";
	Weight_answersBody_typeBody_compositionTranslations_fa get weight_answers => Weight_answersBody_typeBody_compositionTranslations_fa(this);
	String get hungry => """کی گرسنه هستید؟""";
	Hungry_answersBody_typeBody_compositionTranslations_fa get hungry_answers => Hungry_answersBody_typeBody_compositionTranslations_fa(this);
	String get people_perception => """مردم شما را چگونه توصیف میکنند؟""";
	People_perception_answersBody_typeBody_compositionTranslations_fa get people_perception_answers => People_perception_answersBody_typeBody_compositionTranslations_fa(this);
}

class Body_status_answersBody_typeBody_compositionTranslations_fa extends Body_status_answersBody_typeBody_compositionTranslations {
	final Body_typeBody_compositionTranslations_fa _parent;
	const Body_status_answersBody_typeBody_compositionTranslations_fa(this._parent):super(_parent);
	String get a1 => """بدن چربی دار""";
	String get a2 => """بدن غضلانی یا گوشتی""";
	String get a3 => """بدن استخانی""";
}

class Body_shape_answersBody_typeBody_compositionTranslations_fa extends Body_shape_answersBody_typeBody_compositionTranslations {
	final Body_typeBody_compositionTranslations_fa _parent;
	const Body_shape_answersBody_typeBody_compositionTranslations_fa(this._parent):super(_parent);
	String get a1 => """گرد و لخت""";
	String get a2 => """چهارشانه و غضلانی""";
	String get a3 => """باریک و بلند""";
}

class Childhood_answersBody_typeBody_compositionTranslations_fa extends Childhood_answersBody_typeBody_compositionTranslations {
	final Body_typeBody_compositionTranslations_fa _parent;
	const Childhood_answersBody_typeBody_compositionTranslations_fa(this._parent):super(_parent);
	String get a1 => """گوشتالو""";
	String get a2 => """نرمال و طبیعی""";
	String get a3 => """لاغر و ضعیف""";
}

class Activity_answersBody_typeBody_compositionTranslations_fa extends Activity_answersBody_typeBody_compositionTranslations {
	final Body_typeBody_compositionTranslations_fa _parent;
	const Activity_answersBody_typeBody_compositionTranslations_fa(this._parent):super(_parent);
	String get a1 => """بی تحرک""";
	String get a2 => """تقریباً فعال""";
	String get a3 => """بسیار فعال""";
}

class Metabolism_answersBody_typeBody_compositionTranslations_fa extends Metabolism_answersBody_typeBody_compositionTranslations {
	final Body_typeBody_compositionTranslations_fa _parent;
	const Metabolism_answersBody_typeBody_compositionTranslations_fa(this._parent):super(_parent);
	String get a1 => """کند و آهسته""";
	String get a2 => """سالم و طبیعی""";
	String get a3 => """بالا و سریع""";
}

class People_say_answersBody_typeBody_compositionTranslations_fa extends People_say_answersBody_typeBody_compositionTranslations {
	final Body_typeBody_compositionTranslations_fa _parent;
	const People_say_answersBody_typeBody_compositionTranslations_fa(this._parent):super(_parent);
	String get a1 => """باید وزنتان را کم کنید""";
	String get a2 => """فرم خوبی دارید""";
	String get a3 => """باید وزنتان را افزایش دهید""";
}

class Wrist_answersBody_typeBody_compositionTranslations_fa extends Wrist_answersBody_typeBody_compositionTranslations {
	final Body_typeBody_compositionTranslations_fa _parent;
	const Wrist_answersBody_typeBody_compositionTranslations_fa(this._parent):super(_parent);
...
class Weight_answersBody_typeBody_compositionTranslations_fa extends Weight_answersBody_typeBody_compositionTranslations {
	final Body_typeBody_compositionTranslations_fa _parent;
	const Weight_answersBody_typeBody_compositionTranslations_fa(this._parent):super(_parent);
...
class Hungry_answersBody_typeBody_compositionTranslations_fa extends Hungry_answersBody_typeBody_compositionTranslations {
	final Body_typeBody_compositionTranslations_fa _parent;
	const Hungry_answersBody_typeBody_compositionTranslations_fa(this._parent):super(_parent);
	String get a1 => """تقریبا همیشه""";
	String get a2 => """فقط زمان وعده های غذایی""";
	String get a3 => """بندرت و خیلی کم""";
}

class People_perception_answersBody_typeBody_compositionTranslations_fa extends People_perception_answersBody_typeBody_compositionTranslations {
	final Body_typeBody_compositionTranslations_fa _parent;
	const People_perception_answersBody_typeBody_compositionTranslations_fa(this._parent):super(_parent);
