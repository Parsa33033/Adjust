...
ClientDTO _$ClientDTOFromJson(Map<String, dynamic> json) {
  return ClientDTO(
    ...
    json['medicalProfileId'] as int,
    json['medicalProfile'] == null
        ? null
        : MedicalProfileDTO.fromJson(
            json['medicalProfile'] as Map<String, dynamic>),
    (json['orders'] as List)
        ?.map((e) =>
            e == null ? null : OrderDTO.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    (json['tutorialList'] as List)
        ?.map((e) =>
...
Map<String, dynamic> _$ClientDTOToJson(ClientDTO instance) => <String, dynamic>{
      ...
      'medicalProfileId': instance.medicalProfileId,
      'medicalProfile': instance.medicalProfile,
      'orders': instance.orders,
      'tutorialList': instance.tutorialList,
    };
